...
int sspar_factor(sspar_t* this, mpz_t d, const mpz_t N) {
  ...
  /*
  // These are the indices for the theoretically optimal values
  // (give or take).
  static const int primorial_indexes[43] = {
    7, 7, 9, 10, 11, 12, 15, 17, 19, 22, 24, 28,
    31, 35, 39, 44, 48, 55, 63, 69, 77, 86, 97,
    106, 120, 133, 147, 163, 181, 200, 221, 244,
    271, 298, 328, 364, 401, 440, 481, 531, 584,
    640, 699};
  static const int steps_indexes[43] = {
    3, 4, 4, 5, 7, 8, 9, 10, 12, 14, 15,
    17, 18, 20, 22, 24, 25, 27, 29, 31,
    33, 35, 38, 40, 43, 46, 49, 52, 53,
    57, 58, 61, 62, 64, 66, 69, 73, 75,
    78, 82, 85, 89, 93};
  */
